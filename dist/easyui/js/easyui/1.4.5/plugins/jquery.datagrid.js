...
/*$(_205).html(_208.join(""));*/
if($(_205).hasClass("mCustomScrollbar")){
    $(_205).find(".mCSB_container").html(_208.join(""));
}else{
    $(_205).html(_208.join(""));
}
            ...
            return jq.each(function(){
                ...
                trs.easyui_draggable({
                   ...
                   proxy: function(source) {/////
						...
						var dragHtml = tr2.clone().removeAttr('id').removeClass('droppable').css({'background':'#3e9bd0'});
						...
						$('<td><span style="position:static">&nbsp;</span></td>').insertBefore(p.find('td:first'));
                    ...
                    onBeforeDrag:function(e){
                        ...
                        opts.finder.getTr(target, $(this).attr('datagrid-row-index')).easyui_droppable({accept:'no-accept'});
                    },
                    ...
                    onStopDrag:function(){
                        for(var i=0; i<state.disabledRows.length; i++){
                            ...
                            if (index >= 0){
                                opts.finder.getTr(target, index).easyui_droppable('enable');
                            }
                        }
                        state.disabledRows = [];
