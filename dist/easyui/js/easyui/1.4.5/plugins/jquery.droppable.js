...
$.fn.easyui_droppable=function(_7,_8){
if(typeof _7=="string"){
return $.fn.easyui_droppable.methods[_7](this,_8);
}
_7=_7||{};
...
_1(this);
$.data(this,"droppable",{options:$.extend({},$.fn.easyui_droppable.defaults,$.fn.easyui_droppable.parseOptions(this),_7)});
}
});
};
$.fn.easyui_droppable.methods={options:function(jq){
return $.data(jq[0],"droppable").options;
},enable:function(jq){
return jq.each(function(){
$(this).easyui_droppable({disabled:false});
});
},disable:function(jq){
return jq.each(function(){
$(this).easyui_droppable({disabled:true});
});
}};
$.fn.easyui_droppable.parseOptions=function(_a){
var t=$(_a);
return $.extend({},$.parser.parseOptions(_a,["accept"]),{disabled:(t.attr("disabled")?true:undefined)});
};
$.fn.easyui_droppable.defaults={accept:null,disabled:false,onDragEnter:function(e,_b){
