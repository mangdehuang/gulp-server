...
var _15=$(this);
if(_15.easyui_droppable("options").disabled){
return;
}
var p2=_15.offset();
...
var _1f=$(this);
if(_1f.easyui_droppable("options").disabled){
return;
}
var p2=_1f.offset();
...
$.fn.easyui_draggable=function(_20,_21){
if(typeof _20=="string"){
return $.fn.easyui_draggable.methods[_20](this,_21);
}
...
_22=$.extend({},$.fn.easyui_draggable.defaults,$.fn.easyui_draggable.parseOptions(this),_20||{});
}
...
$.fn.easyui_draggable.methods={options:function(jq){
...
$.fn.easyui_draggable.parseOptions=function(_30){
var t=$(_30);
...
$.fn.easyui_draggable.defaults={proxy:null,revert:false,cursor:"move",deltaX:null,deltaY:null,handle:null,disabled:false,edge:0,axis:null,delay:100,onBeforeDrag:function(e){
